...
// Contactコンポーネントが受け取るPropsの型を定義します
interface ContactProps {
  // `handleContactSubmit`は、フォーム送信イベントを受け取る関数です
    ...
    <section id="contact" className="py-20 md:py-32 min-h-screen flex items-center">
      <div className="max-w-2xl mx-auto w-full">
        ...
        <div className="bg-[#e8dbc6] p-6 md:p-8 rounded-lg shadow-md">
          {/* `onSubmit`に関数を渡すと、その関数は引数としてイベントオブジェクトを受け取ります。
            型定義により、このイベントオブジェクトが`React.FormEvent<HTMLFormElement>`型であることが保証されます。
          */}
