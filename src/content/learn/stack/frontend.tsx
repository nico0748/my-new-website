  ...
  return (
    <>
      ...
      <ComparisonTable
        ...
        rows={[
          [<Tech id="react">React</Tech>, "巨大なエコシステム。ライブラリで組み立てる自由度", "採用実績・求人が最多。迷ったら第一候補"],
          [<Tech id="vue">Vue</Tech>, "学習しやすく、単一ファイルコンポーネントが直感的", "小〜中規模、段階的導入"],
          [<Tech id="angular">Angular</Tech>, "全部入りのフルフレームワーク（DI・ルーター等標準）", "大規模・エンタープライズ"],
          [<Tech id="svelte">Svelte</Tech>, "コンパイル時に素の JS へ変換。ランタイムが軽い", "軽量・高速を重視するアプリ"],
        ]}
      />
      ...
      <ComparisonTable
        headers={["層", "代表", "役割"]}
        rows={[
          ["言語", <Tech id="typescript">TypeScript</Tech>, "型で安全性と補完を得る。実務ではほぼ標準"],
          ["ビルド/開発サーバー", <><Tech id="vite">Vite</Tech>・Turbopack・（webpack）</>, "高速な開発サーバーと本番バンドル"],
          ["CSS 手法", <><Tech id="tailwind">Tailwind CSS</Tech>・CSS Modules・CSS-in-JS</>, "スタイルの書き方。近年は Tailwind が人気"],
