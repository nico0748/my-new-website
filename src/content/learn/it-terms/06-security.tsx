...
export const RELATED: Record<string, string[]> = {
  "サイバーセキュリティ": ["CIA トライアド", "脅威 / 脆弱性 / リスク", "インシデント", "ネットリテラシー", "モニタリング"],
  "CIA トライアド": ["サイバーセキュリティ", "多層防御", "最小権限の原則"],
  "脅威 / 脆弱性 / リスク": ["脆弱性", "脅威インテリジェンス", "脆弱性管理", "PoC"],
  "脆弱性": ["エクスプロイト", "PoC", "脆弱性診断", "パッチ", "CI / CD"],
  "エクスプロイト": ["脆弱性", "PoC", "Exploit Kit", "ゼロデイ攻撃"],
  "PoC": ["脆弱性", "エクスプロイト", "責任ある開示"],
  "アタックサーフェス": ["多層防御", "最小権限の原則", "API"],
  "ゼロトラスト": ["ZTNA", "最小権限の原則", "多層防御", "クラウド"],
  "ZTNA": ["ゼロトラスト", "SASE", "最小権限の原則", "クラウド"],
  "多層防御": ["ゼロトラスト", "アタックサーフェス", "ファイアウォール", "EDR", "冗長化"],
  "最小権限の原則": ["ゼロトラスト", "特権の昇格", "特権 ID", "環境変数"],
  "セキュアコーディング": ["脆弱性診断", "SAST / DAST / SCA", "DevSecOps / シフトレフト", "サニタイズ / エスケープ", "レビュー"],
  "インシデント": ["インシデント対応", "CSIRT（CERT）", "不正アクセス", "モニタリング"],
  "不正アクセス": ["なりすまし", "バックドア", "インシデント", "API"],
  "なりすまし": ["スプーフィング", "フィッシング詐欺", "セッション"],
  "ハッキング": ["ペネトレーションテスト", "エクスプロイト", "不正アクセス"],
  "踏み台": ["C&C サーバー", "Botnet", "ラテラルムーブメント", "サーバー"],
  "サイバーテロ": ["APT", "サイバーキルチェーン", "標的型攻撃"],
  "アノニマス": ["サイバーテロ", "DDoS 攻撃", "ハッキング"],
  "ネットリテラシー": ["フィッシング詐欺", "スパム", "サイバーセキュリティ"],

  "マルウェア": ["ウイルス", "ワーム", "トロイの木馬", "ランサムウェア"],
  "ウイルス": ["ワーム", "トロイの木馬", "マルウェア"],
  "ワーム": ["ウイルス", "Botnet", "コンフィッカー"],
  "トロイの木馬": ["バックドア", "RAT", "Emotet"],
  "ランサムウェア": ["RaaS", "暗号化 / 復号", "バックドア", "バックアップ / スナップショット"],
  "スパイウェア": ["キーロガー", "ストーカーウェア", "アドウェア"],
  "アドウェア": ["スパイウェア", "PUA", "スケアウェア"],
  "キーロガー": ["スパイウェア", "RAT", "バンキングトロージャン"],
  "バックドア": ["トロイの木馬", "RAT", "特権の昇格", "サーバー"],
  "RAT": ["バックドア", "トロイの木馬", "C&C サーバー"],
  "Bot": ["Botnet", "C&C サーバー", "DDoS 攻撃"],
  "Botnet": ["Bot", "C&C サーバー", "DDoS 攻撃"],
  "C&C サーバー": ["Bot", "Botnet", "踏み台", "サーバー"],
  "ドロッパー": ["ダウンローダー", "パッカー", "Exploit Kit"],
  "ダウンローダー": ["ドロッパー", "Malspam", "トロイの木馬"],
  "パッカー": ["ドロッパー", "ステルス", "ヒューリスティック"],
  "バンキングトロージャン": ["Zbot（ZeuS）", "Dridex", "キーロガー"],
  "スケアウェア": ["サポート詐欺", "アドウェア", "フィッシングサイト"],
  "ストーカーウェア": ["スパイウェア", "ネットストーカー", "ドキシング"],
  "ブラウザ・ハイジャッカー": ["アドウェア", "PUA", "ブラウザーフィンガープリント", "URL"],
  "PUA": ["アドウェア", "ブラウザ・ハイジャッカー", "スケアウェア"],
  "ステルス": ["パッカー", "ヒューリスティック", "サンドボックス"],
  "オートラン": ["ワーム", "ウイルス", "コンフィッカー"],
  "クリプトジャッキング": ["暗号資産（仮想通貨）", "Bot", "ブロックチェーン", "インスタンス"],
  "Exploit Kit": ["ドライブ・バイ・ダウンロード", "エクスプロイト", "ドロッパー"],
  "マニピュレーションサーバー": ["MITM 攻撃", "C&C サーバー", "スプーフィング", "サーバー"],

  "Emotet": ["トロイの木馬", "Malspam", "ダウンローダー"],
  "Dridex": ["バンキングトロージャン", "Malspam"],
  "Zbot（ZeuS）": ["バンキングトロージャン", "キーロガー"],
  "コンフィッカー": ["ワーム", "オートラン"],
  "ガンブラー": ["水飲み場型攻撃", "ドライブ・バイ・ダウンロード"],
  "メリッサ": ["ウイルス", "チェーンメール"],
  "Rbot": ["Bot", "IRC"],
  "Delf": ["トロイの木馬", "パッカー"],
  "Dorkbot": ["ワーム", "Bot", "パスワードリスト攻撃"],
  "Sirefef（ZeroAccess）": ["クリプトジャッキング", "ステルス"],

  "SQL インジェクション": ["プレースホルダ", "サニタイズ / エスケープ", "OWASP Top 10", "API"],
  "クロスサイトスクリプティング": ["CSP / セキュリティヘッダ", "サニタイズ / エスケープ", "クロスサイトリクエストフォージェリ", "DOM"],
  "クロスサイトリクエストフォージェリ": ["クロスサイトスクリプティング", "セッション", "Cookie", "CORS"],
  "クリックジャッキング": ["CSP / セキュリティヘッダ", "クロスサイトスクリプティング", "DOM"],
  "ディレクトリトラバーサル": ["パス", "IDOR", "OWASP Top 10", "URL"],
  "バッファオーバーフロー": ["エクスプロイト", "Heartbleed", "特権の昇格"],
  "OS コマンドインジェクション": ["SQL インジェクション", "サニタイズ / エスケープ"],
  "SSRF": ["IDOR", "OWASP Top 10", "非武装ネットワーク（DMZ）", "リクエスト / レスポンス"],
  "IDOR": ["SSRF", "認証 / 認可", "OWASP Top 10", "API"],
  "OWASP Top 10": ["SQL インジェクション", "クロスサイトスクリプティング", "脆弱性診断", "API"],
  "ブラクラ": ["DoS 攻撃", "スパム"],
  "ActiveX": ["ブラウザ・ハイジャッカー", "パッチ"],

  "DoS 攻撃": ["DDoS 攻撃", "フラッディング攻撃", "帯域 / トラフィック"],
  "DDoS 攻撃": ["DoS 攻撃", "Botnet", "DNS リフレクター攻撃", "帯域 / トラフィック"],
  "フラッディング攻撃": ["DoS 攻撃", "DDoS 攻撃", "帯域 / トラフィック"],
  "ICMP 攻撃": ["フラッディング攻撃", "DoS 攻撃", "ICMP"],
  "DNS キャッシュポイズニング": ["ファーミング", "スプーフィング", "DNS", "名前解決"],
  "DNS リフレクター攻撃": ["オープンリゾルバ", "DDoS 攻撃", "DNS", "名前解決"],
  "オープンリゾルバ": ["DNS リフレクター攻撃", "DNS", "名前解決"],
  "MITM 攻撃": ["MITB 攻撃", "スプーフィング", "SSL / TLS", "プロキシ"],
  "MITB 攻撃": ["MITM 攻撃", "トロイの木馬", "バンキングトロージャン"],
  "スプーフィング": ["なりすまし", "DNS キャッシュポイズニング", "MITM 攻撃", "IP アドレス"],
  "ドメイン名ハイジャック": ["DNS", "スプーフィング", "ドメイン", "名前解決"],

  "標的型攻撃": ["APT", "スピアフィッシング", "サプライチェーン攻撃"],
  "APT": ["標的型攻撃", "サイバーキルチェーン", "ラテラルムーブメント"],
  "ゼロデイ攻撃": ["脆弱性", "エクスプロイト", "パッチ", "CI / CD"],
  "ドライブ・バイ・ダウンロード": ["水飲み場型攻撃", "Exploit Kit", "ガンブラー", "URL"],
  "水飲み場型攻撃": ["ドライブ・バイ・ダウンロード", "標的型攻撃", "ガンブラー"],
  "サプライチェーン攻撃": ["標的型攻撃", "イニシャルアクセスブローカー", "パッケージマネージャ"],
  "イニシャルアクセスブローカー": ["サプライチェーン攻撃", "ダークマーケット", "CaaS"],
  "サイバーキルチェーン": ["APT", "ラテラルムーブメント", "MITRE ATT&CK"],
  "ラテラルムーブメント": ["特権の昇格", "サイバーキルチェーン", "APT", "コンテナ"],
  "特権の昇格": ["ラテラルムーブメント", "最小権限の原則", "root 化 / Jailbreak", "コンテナ"],
  "Shellshock": ["Heartbleed", "脆弱性", "エクスプロイト", "環境変数"],
  "Heartbleed": ["Shellshock", "SSL / TLS", "脆弱性", "HTTPS"],
  "root 化 / Jailbreak": ["特権の昇格", "最小権限の原則"],

  "ブルートフォース攻撃": ["リバースブルートフォース", "パスワードリスト攻撃", "多要素認証（MFA）"],
  "リバースブルートフォース": ["ブルートフォース攻撃", "パスワードリスト攻撃"],
  "パスワードリスト攻撃": ["アカウントリスト攻撃", "ブルートフォース攻撃", "多要素認証（MFA）"],
  "アカウントリスト攻撃": ["パスワードリスト攻撃", "ブルートフォース攻撃"],

  "ソーシャル・エンジニアリング": ["フィッシング詐欺", "サポート詐欺", "ビッシング"],
  "フィッシング詐欺": ["フィッシングサイト", "スピアフィッシング", "スミッシング", "ビッシング", "URL"],
  "フィッシングサイト": ["フィッシング詐欺", "ファーミング", "PhaaS", "URL"],
  "スピアフィッシング": ["フィッシング詐欺", "標的型攻撃"],
  "スミッシング": ["フィッシング詐欺", "ビッシング"],
  "ビッシング": ["フィッシング詐欺", "スミッシング", "サポート詐欺"],
  "ファーミング": ["DNS キャッシュポイズニング", "フィッシングサイト", "名前解決"],
  "サポート詐欺": ["スケアウェア", "ビッシング", "ソーシャル・エンジニアリング"],
  "スパム": ["Malspam", "チェーンメール", "メールフィルタリング"],
  "Malspam": ["スパム", "ダウンローダー", "フィッシング詐欺"],
  "チェーンメール": ["スパム", "ネットリテラシー"],
  "ドキシング": ["ネットストーカー", "ストーカーウェア"],
  "ネットストーカー": ["ドキシング", "ストーカーウェア"],
  "ダークウェブ": ["ダークマーケット", "Tor", "CaaS", "ルーティング"],
  "ダークマーケット": ["ダークウェブ", "CaaS", "RaaS"],
  "CaaS": ["RaaS", "PhaaS", "ダークマーケット"],
  "RaaS": ["ランサムウェア", "CaaS", "PhaaS"],
  "PhaaS": ["フィッシング詐欺", "CaaS", "RaaS"],

  "認証 / 認可": ["多要素認証（MFA）", "シングルサインオン", "OAuth", "セッション"],
  "多要素認証（MFA）": ["二要素認証", "二段階認証", "ワンタイムパスワード", "生体認証"],
  "二要素認証": ["多要素認証（MFA）", "二段階認証", "ワンタイムパスワード"],
  "二段階認証": ["二要素認証", "多要素認証（MFA）", "ワンタイムパスワード"],
  "ワンタイムパスワード": ["多要素認証（MFA）", "二段階認証", "生体認証"],
  "生体認証": ["パスキー", "多要素認証（MFA）", "ワンタイムパスワード"],
  "パスキー": ["生体認証", "シングルサインオン", "認証 / 認可"],
  "パスフレーズ": ["パスワードリスト攻撃", "ブルートフォース攻撃", "ソルト / ストレッチング"],
  "シングルサインオン": ["OAuth", "OpenID", "SAML", "IDaaS", "リダイレクト"],
  "OAuth": ["OpenID", "シングルサインオン", "SAML", "API"],
  "OpenID": ["OAuth", "シングルサインオン", "SAML", "API"],
  "SAML": ["シングルサインオン", "OAuth", "IDaaS", "API"],
  "IDaaS": ["シングルサインオン", "SAML", "MDM", "クラウド"],
  "特権 ID": ["最小権限の原則", "特権の昇格", "MDM"],
  "BYOD": ["シャドー IT", "MDM"],
  "シャドー IT": ["BYOD", "MDM"],
  "MDM": ["BYOD", "シャドー IT", "特権 ID"],

  "暗号化 / 復号": ["共通鍵暗号方式", "公開鍵暗号方式", "AES", "HTTPS"],
  "共通鍵暗号方式": ["公開鍵暗号方式", "AES", "暗号化 / 復号"],
  "公開鍵暗号方式": ["共通鍵暗号方式", "デジタル署名 / 電子署名", "デジタル証明書"],
  "AES": ["共通鍵暗号方式", "暗号化 / 復号"],
  "ハッシュ値": ["ソルト / ストレッチング", "デジタル署名 / 電子署名", "ハッシュ（辞書 / 集合）"],
  "ソルト / ストレッチング": ["ハッシュ値", "パスフレーズ", "ブルートフォース攻撃"],
  "デジタル署名 / 電子署名": ["デジタル証明書", "公開鍵暗号方式", "ハッシュ値"],
  "デジタル証明書": ["デジタル署名 / 電子署名", "公開鍵暗号方式", "SSL / TLS", "HTTPS"],
  "SSL / TLS": ["デジタル証明書", "VPN", "MITM 攻撃", "HTTPS"],
  "IPsec": ["VPN", "SSL / TLS", "プロトコル"],
  "VPN": ["IPsec", "SSL / TLS", "プロキシサーバー", "プロキシ"],
  "SSH": ["VPN", "RDP", "公開鍵暗号方式", "ポート"],
  "Tor": ["ダークウェブ", "VPN", "プロキシサーバー", "ルーティング"],
  "ステガノグラフィ": ["暗号化 / 復号", "デジタル署名 / 電子署名"],
  "量子暗号": ["公開鍵暗号方式", "暗号化 / 復号"],
  "WEP / WPA / WPA2 / WPA3": ["SSID", "TKIP", "LAN / WAN"],
  "TKIP": ["WEP / WPA / WPA2 / WPA3", "SSID"],
  "SSID": ["WEP / WPA / WPA2 / WPA3", "TKIP", "LAN / WAN"],

  "ファイアウォール": ["WAF", "パーソナルファイアウォール", "UTM", "IDS", "ゲートウェイ"],
  "パーソナルファイアウォール": ["ファイアウォール", "UTM"],
  "WAF": ["ファイアウォール", "OWASP Top 10", "IPS", "リバースプロキシ"],
  "IDS": ["IPS", "ファイアウォール", "SIEM", "ルータ"],
  "IPS": ["IDS", "WAF", "UTM", "ルーティング"],
  "UTM": ["ファイアウォール", "IDS", "IPS"],
  "非武装ネットワーク（DMZ）": ["ファイアウォール", "プロキシサーバー", "SSRF", "サブネット / CIDR"],
  "プロキシサーバー": ["非武装ネットワーク（DMZ）", "VPN", "SWG", "リバースプロキシ"],
  "SWG": ["Web フィルタリング", "CASB", "プロキシサーバー", "プロキシ"],
  "CASB": ["SASE", "SWG", "シャドー IT", "クラウド"],
  "SASE": ["CASB", "ZTNA", "SWG", "クラウド"],
  "DLP": ["CASB", "特権 ID", "脅威インテリジェンス", "構造化データ / 非構造化データ"],
  "EDR": ["XDR", "MDR", "SIEM"],
  "XDR": ["EDR", "MDR", "SIEM"],
  "MDR": ["EDR", "XDR", "MSS"],
  "MSS": ["MDR", "SOC", "CSIRT（CERT）"],
  "サンドボックス": ["ハニーポット", "ヒューリスティック", "ファジング", "コンテナ"],
  "ハニーポット": ["サンドボックス", "ターピット", "脅威インテリジェンス", "サーバー"],
  "ターピット": ["ハニーポット", "DDoS 攻撃"],
  "ヒューリスティック": ["プロアクティブ検知", "サンドボックス", "ステルス"],
  "プロアクティブ検知": ["ヒューリスティック", "脅威インテリジェンス", "IoC"],
  "Web フィルタリング": ["メールフィルタリング", "SWG", "フィッシングサイト", "URL"],
  "メールフィルタリング": ["Web フィルタリング", "スパム", "SPF / DKIM / DMARC"],
  "ネットワーク検疫": ["MDM", "BYOD", "多層防御", "サブネット / CIDR"],
  "SPF / DKIM / DMARC": ["メールフィルタリング", "スプーフィング", "フィッシング詐欺", "名前解決"],
  "EMET": ["バッファオーバーフロー", "パッチ", "エクスプロイト"],
  "CSP / セキュリティヘッダ": ["クロスサイトスクリプティング", "クリックジャッキング", "ヘッダ / ボディ"],
  "サニタイズ / エスケープ": ["SQL インジェクション", "クロスサイトスクリプティング", "OS コマンドインジェクション", "リクエスト / レスポンス"],
  "パッチ": ["脆弱性管理", "ゼロデイ攻撃", "脆弱性", "CI / CD"],
  "アプライアンス": ["UTM", "ファイアウォール", "サーバー"],

  "脆弱性診断": ["ペネトレーションテスト", "脆弱性管理", "OWASP Top 10", "テスト"],
  "ペネトレーションテスト": ["脆弱性診断", "ファジング", "脅威モデリング / STRIDE", "テスト"],
  "ファジング": ["ペネトレーションテスト", "SAST / DAST / SCA", "脆弱性診断", "テスト"],
  "SAST / DAST / SCA": ["DevSecOps / シフトレフト", "ファジング", "脆弱性診断", "CI / CD"],
  "DevSecOps / シフトレフト": ["SAST / DAST / SCA", "セキュアコーディング", "脅威モデリング / STRIDE", "CI / CD"],
  "脅威モデリング / STRIDE": ["DevSecOps / シフトレフト", "アタックサーフェス", "ペネトレーションテスト"],

  "CSIRT（CERT）": ["SOC", "インシデント対応", "フォレンジック"],
  "SOC": ["CSIRT（CERT）", "SIEM", "MSS", "モニタリング"],
  "SIEM": ["SOC", "EDR", "ログ", "モニタリング"],
  "ログ": ["SIEM", "フォレンジック", "IoC", "オブザーバビリティ"],
  "フォレンジック": ["ログ", "インシデント対応", "IoC"],
  "インシデント対応": ["CSIRT（CERT）", "フォレンジック", "インシデント", "SRE"],
  "脅威インテリジェンス": ["IoC", "OSINT", "MITRE ATT&CK"],
  "IoC": ["脅威インテリジェンス", "フォレンジック", "ログ"],
  "OSINT": ["脅威インテリジェンス", "フォレンジック"],
  "MITRE ATT&CK": ["サイバーキルチェーン", "脅威インテリジェンス", "脅威モデリング / STRIDE"],
  "脆弱性管理": ["CVE / CVSS / CWE", "KEV / EPSS", "パッチ", "脆弱性診断", "CI / CD"],
  "CVE / CVSS / CWE": ["脆弱性管理", "KEV / EPSS", "責任ある開示"],
  "KEV / EPSS": ["CVE / CVSS / CWE", "脆弱性管理"],
  "責任ある開示": ["PoC", "CVE / CVSS / CWE", "脆弱性"],
  "ISMS": ["コンプライアンス", "脆弱性管理", "PCI DSS"],
  "コンプライアンス": ["ISMS", "個人情報保護法", "PCI DSS"],
  "個人情報保護法": ["コンプライアンス", "ISMS"],
  "PCI DSS": ["コンプライアンス", "ISMS"],

  "IaaS / PaaS / SaaS": ["DaaS / iPaaS", "クラウド", "コンテナ"],
  "DaaS / iPaaS": ["IaaS / PaaS / SaaS", "クラウド", "サーバーレス"],
  "CDN": ["DDoS 攻撃", "DNS", "プロキシサーバー", "帯域 / トラフィック"],
  "DNS": ["DNS キャッシュポイズニング", "DNS リフレクター攻撃", "ドメイン名ハイジャック", "名前解決"],
  "Cookie": ["セッション", "クロスサイトリクエストフォージェリ", "ブラウザーフィンガープリント", "state"],
  "パケット": ["フラッディング攻撃", "ICMP 攻撃", "TCP/IP"],
  "グローバル IP アドレス": ["NAT", "スプーフィング", "IP アドレス"],
  "NAS": ["ファイル共有ソフト", "MDM", "バックアップ / スナップショット"],
  "SNMP": ["MDM", "ネットワーク検疫", "モニタリング"],
  "RDP": ["SSH", "MITM 攻撃", "ラテラルムーブメント", "ポート"],
  "IRC": ["Bot", "Botnet", "C&C サーバー"],
  "テザリング": ["BYOD", "シャドー IT"],
  "シンクライアント": ["MDM", "特権 ID", "仮想化"],
  "ファイル共有ソフト": ["NAS", "ドキシング"],
  "IoT": ["Botnet", "脆弱性管理", "多層防御"],
  "人工知能": ["機械学習", "LLM（大規模言語モデル）", "ヒューリスティック"],
  "ブロックチェーン": ["暗号資産（仮想通貨）", "デジタル署名 / 電子署名", "NFT"],
  "暗号資産（仮想通貨）": ["ブロックチェーン", "クリプトジャッキング", "NFT"],
  "NFT": ["ブロックチェーン", "暗号資産（仮想通貨）"],
  "Web3.0": ["ブロックチェーン", "暗号資産（仮想通貨）", "エコシステム"],
  "エコシステム": ["Web3.0", "IaaS / PaaS / SaaS"],
  "ブラウザーフィンガープリント": ["Cookie", "ブラウザ・ハイジャッカー", "OSINT", "ヘッダ / ボディ"],
};
